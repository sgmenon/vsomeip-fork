...
uint16_t profile_05::compute_crc(const profile_config& _config, const buffer_view& _buffer) {
...
bool profile_05::is_buffer_length_valid(const profile_config& _config, const buffer_view& _buffer) {
