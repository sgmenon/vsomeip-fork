...
public:
    ...
    virtual bool get_client_port(service_t _service, instance_t _instance, uint16_t _remote_port, bool _reliable,
    ...
    virtual uint8_t get_threshold(service_t _service, instance_t _instance, eventgroup_t _eventgroup) const = 0;

    virtual void get_event_update_properties(service_t _service, instance_t _instance, event_t _event, std::chrono::milliseconds& _cycle,
    ...
    virtual reliability_type_e get_event_reliability(service_t _service, instance_t _instance, event_t _event) const = 0;
    virtual reliability_type_e get_service_reliability(service_t _service, instance_t _instance) const = 0;
    ...
    virtual std::map<std::string, std::string> get_additional_data(const std::string& _application_name,
    ...
    // Debouncing
    virtual std::shared_ptr<debounce_filter_impl_t> get_default_debounce(service_t _service, instance_t _instance,
                                                                         event_t _event) const = 0;
    virtual std::shared_ptr<debounce_filter_impl_t> get_debounce(const std::string& _name, service_t _service, instance_t _instance,
                                                                 event_t _event) const = 0;
    ...
    typedef std::map<boost::asio::ip::address, // other device
    ...
    virtual void set_sd_acceptance_rules_active(const boost::asio::ip::address& _address, bool _enable) = 0;
