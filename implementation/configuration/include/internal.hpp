...
#define VSOMEIP_ENV_SD_MODULE                   "VSOMEIP_SD_MODULE"
...
#define VSOMEIP_DEFAULT_TCP_RECEIVE_BUFFER_POOL_SIZE 8
...
enum class port_type_e { PT_OPTIONAL, PT_SECURE, PT_UNSECURE, PT_UNKNOWN };
