...
bool local_tcp_client_endpoint_impl::send(const buffer_sequence_ptr_t& _sequence) {
...
void local_tcp_client_endpoint_impl::send_queued(std::pair<buffer_sequence_ptr_t, uint32_t>& _entry) {
