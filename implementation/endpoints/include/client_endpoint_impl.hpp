...
public:
    ...
    virtual void send_cbk(boost::system::error_code const& _error, std::size_t _bytes, const buffer_sequence_ptr_t& _sent_msg);
...
protected:
    ...
    std::pair<buffer_sequence_ptr_t, uint32_t> get_front();
