...
typedef client_endpoint_impl<boost::asio::ip::tcp> tcp_client_endpoint_base_impl;
...
public:
    ...
    void send_cbk(boost::system::error_code const& _error, std::size_t _bytes, const buffer_sequence_ptr_t& _sent_msg);

private:
    void send_queued(std::pair<buffer_sequence_ptr_t, uint32_t>& _entry);
    ...
    void send_magic_cookie(buffer_sequence_ptr_t& _sequence);
