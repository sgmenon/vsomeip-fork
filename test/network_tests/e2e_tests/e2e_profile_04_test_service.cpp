...
e2e_profile_04_test_service::e2e_profile_04_test_service() :
    ...
    offer_thread_(std::bind(&e2e_profile_04_test_service::run, this)), received_(0) { }

bool e2e_profile_04_test_service::init() {
    ...
    app_->register_message_handler(PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_METHOD,
                                   std::bind(&e2e_profile_04_test_service::on_message, this, std::placeholders::_1));

    app_->register_message_handler(PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_SHUTDOWN,
                                   std::bind(&e2e_profile_04_test_service::on_message_shutdown, this, std::placeholders::_1));

    app_->register_state_handler(std::bind(&e2e_profile_04_test_service::on_state, this, std::placeholders::_1));

    // E2E Profile 04: Event 8001
    app_->offer_event(PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_EVENT, {PROFILE_04_EVENTGROUP}, vsomeip::event_type_e::ET_FIELD,
...
void e2e_profile_04_test_service::join_offer_thread() {
...
void e2e_profile_04_test_service::offer() {

    app_->offer_service(PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_MAJOR, PROFILE_04_MINOR);
}

void e2e_profile_04_test_service::stop_offer() {

    app_->stop_offer_service(PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_MAJOR, PROFILE_04_MINOR);
}
...
void e2e_profile_04_test_service::on_message(const std::shared_ptr<vsomeip::message>& _request) {
...
void e2e_profile_04_test_service::run() {
