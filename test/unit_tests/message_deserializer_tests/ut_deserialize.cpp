...
TEST(deserialize_test, deserialize_message) {
    ...
    std::array<vsomeip_v3::byte_t, 25> byte_array_{byte1, byte2, byte3, byte4, 0,     0,     0,     8, byte4, byte1, byte1, byte2, byte3,
                                                   byte4, byte1, byte1, byte2, byte3, byte4, byte1, 0, 0,     0,     0,     0};
